...
do
    ...
    do
        ...
        do
            ...
            sbatch -J "get_mode_traj_va=${va}_tau=${tau}_lambda=${lambda}" -o "get_mode_traj_va=${va}_tau=${tau}_lambda=${lambda}.o%j" -e "get_mode_traj_va=${va}_tau=${tau}_lambda=${lambda}.e%j" scripts/submit_get_mode_traj.sh ${the_dir} ${the_dir}
        done
    done
done
